...
import br.com.vr.pes360.dashSRD.manifest.SupplementalProperty;
...
public class DashSRDManifestParser extends DefaultHandler
     ...
     */
    protected static String checkLanguageConsistency(String firstLanguage, String secondLanguage) {
     ...
     */
    protected static int checkContentTypeConsistency(int firstType, int secondType) {
