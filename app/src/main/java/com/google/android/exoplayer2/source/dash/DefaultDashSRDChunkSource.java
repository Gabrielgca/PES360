...
public class DefaultDashSRDChunkSource implements DashChunkSource {
    ...
    public static final class Factory implements DashChunkSource.Factory {
        ...
        public DashChunkSource createDashChunkSource(LoaderErrorThrower manifestLoaderErrorThrower,
            ...
            return new DefaultDashSRDChunkSource(manifestLoaderErrorThrower, manifest, periodIndex,
     ...
     *     track.
     */
    public DefaultDashSRDChunkSource(LoaderErrorThrower manifestLoaderErrorThrower, DashManifest manifest,
    ...
    public boolean onChunkLoadError(Chunk chunk, boolean cancelable, Exception e) {
        ...
        if (!manifest.dynamic && chunk instanceof MediaChunk
                ...
                && ((HttpDataSource.InvalidResponseCodeException) e).responseCode == 404) {
            RepresentationHolder representationHolder =
