...
import br.com.vr.pes360.dashSRD.track_selection.PyramidalTrackSelection;
...
public class DefaultDashSRDChunkSource implements DashChunkSource {
    ...
    public static final class Factory implements DashChunkSource.Factory {
         ...
         * @param maxSegmentsPerLoad See {@link DefaultDashSRDChunkSource#DefaultDashSRDChunkSource}.
         */
        public Factory(
        ...
        public DashChunkSource createDashChunkSource(
            ...
            return new DefaultDashSRDChunkSource(
     ...
     */
    public DefaultDashSRDChunkSource(
            ChunkExtractor.Factory chunkExtractorFactory,
            LoaderErrorThrower manifestLoaderErrorThrower,
            DashManifest manifest,
            int periodIndex,
        ...
        if (trackSelection instanceof PyramidalTrackSelection) {
            ...
            //ATUALIZAR PyramidalTrackSelection

            pyramidalTrackSelection.updateAdaptationSetIndices(adaptationSetIndices);
        }
    ...
    /**
     * Populates a chunk holder with the next chunk to download.
     *
     * @param playbackPositionUs The current playback position. If {@code previous} is null then this
     *     parameter is the position from which playback is expected to start (or restart).
    ...
    public void getNextChunk(
        ...
        if (trackSelection instanceof PyramidalTrackSelection) {
            ...
            long segmentIndex;
            if (previous == null) {
                long availableSegmentCount = representationHolder.getSegmentCount();
