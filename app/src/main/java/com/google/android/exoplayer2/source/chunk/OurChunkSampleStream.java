 ...
 *
 * Ver CurrentChunk e como utilizar no log da qualidade
 */
 ...
 */
public class OurChunkSampleStream<T extends ChunkSource>
    ...
    public interface ReleaseCallback<T extends ChunkSource> {
        ...
        /**
         * Called when the {@link OurChunkSampleStream} has finished being released.
         *
         * @param chunkSampleStream The released sample stream.
         */
        void onSampleStreamReleased(OurChunkSampleStream<T> chunkSampleStream);
    }

    private static final String TAG = "OurChunkSampleStream";
...
//    private final SequenceableLoader.Callback<OurChunkSampleStream<T>> callback;
     ...
     * @param adaptationSetIndices    The index of the associated adaptation set.
    ...
    public OurChunkSampleStream(
        ...
        loader = new Loader("OurChunkSampleStream");
    ...
    public boolean continueLoading(long playbackPositionUs) {
        ...
        chunkSource.getNextChunk(playbackPositionUs, loadPositionUs, chunkQueue, nextChunkHolder);
        ...
        if (isMediaChunk(loadable)) {
            ...
            if (mediaChunks.size() > 0) {
                // Check whether some discarding is needed (i.e. a better quality in the FoV is
                // desired)
                if (!wasDiscarding /*&& maybeDiscardUpstream(playbackPositionUs)*/) {
                    wasDiscarding = true;
                    // If discarding actually happens we shouldn't download the next chunk because
                    // it's the wrong one
                    callback.onContinueLoadingRequested(this);
                    return false;
                } else {
...
//    /**
//     * Discards media chunks from the back of the buffer if conditions have changed
//     * such that it's preferable to re-buffer the media at a different quality.
//     *
//     * @param positionUs The current playback position in microseconds.
...
//    }
    ...
    public final class EmbeddedSampleStream implements SampleStream {
        ...
        public EmbeddedSampleStream(OurChunkSampleStream<T> parent, SampleQueue sampleQueue, int index) {
            this.parent = parent;
