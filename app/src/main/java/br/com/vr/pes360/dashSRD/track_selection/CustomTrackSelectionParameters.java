package br.com.vr.pes360.dashSRD.track_selection;
...
public class CustomTrackSelectionParameters implements Parcelable {

    /**
     * A builder for {@link br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters}. See the {@link br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters}
    ...
    public static class Builder {
        ...
        /**
         * @param initialValues The {@link br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters} from which the initial values of
         *     the builder are obtained.
         */
        /* package */ Builder(br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters initialValues) {
         ...
         * @return This builder.
         */
        public br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters.Builder setPreferredAudioLanguage(@Nullable String preferredAudioLanguage) {
         ...
         * @return This builder.
         */
        public br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters.Builder setPreferredAudioLanguages(String... preferredAudioLanguages) {
         ...
         * @return This builder.
         */
        public br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters.Builder setPreferredAudioRoleFlags(@C.RoleFlags int preferredAudioRoleFlags) {
         ...
         * @return This builder.
         */
        public br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters.Builder setPreferredTextLanguageAndRoleFlagsToCaptioningManagerSettings(
                Context context) {
            if (Util.SDK_INT >= 19) {
         ...
         * @return This builder.
         */
        public br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters.Builder setPreferredTextLanguage(@Nullable String preferredTextLanguage) {
         ...
         * @return This builder.
         */
        public br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters.Builder setPreferredTextLanguages(String... preferredTextLanguages) {
            ImmutableList.Builder<String> listBuilder = ImmutableList.builder();
         ...
         * @return This builder.
         */
        public br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters.Builder setPreferredTextRoleFlags(@C.RoleFlags int preferredTextRoleFlags) {
         ...
         * @return This builder.
         */
        public br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters.Builder setSelectUndeterminedTextLanguage(boolean selectUndeterminedTextLanguage) {
         ...
         * @return This builder.
         */
        public br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters.Builder setDisabledTextTrackSelectionFlags(
                @C.SelectionFlags int disabledTextTrackSelectionFlags) {
            this.disabledTextTrackSelectionFlags = disabledTextTrackSelectionFlags;
            return this;
        }

        /** Builds a {@link br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters} instance with the selected values. */
        public br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters build() {
            return new br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters(
                    // Audio
     ...
     *
     * <ul>
     *   <li>{@link br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters.Builder#setPreferredTextLanguageAndRoleFlagsToCaptioningManagerSettings(Context)
     *       Preferred text language and role flags} configured to the accessibility settings of
     *       {@link CaptioningManager}.
     * </ul>
     */
    @SuppressWarnings("deprecation")
    public static final br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters DEFAULT_WITHOUT_CONTEXT = new br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters.Builder().build();

    /**
     * @deprecated This instance is not configured using {@link Context} constraints. Use {@link
     *     #getDefaults(Context)} instead.
     */
    @Deprecated public static final br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters DEFAULT = DEFAULT_WITHOUT_CONTEXT;

    /** Returns an instance configured with default values. */
    public static br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters getDefaults(Context context) {
        return new br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters.Builder(context).build();
    }
    ...
    /* package */ CustomTrackSelectionParameters(
    ...
    /* package */ CustomTrackSelectionParameters(Parcel in) {
    ...
    /** Creates a new {@link br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters.Builder}, copying the initial values from this instance. */
    public br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters.Builder buildUpon() {
        return new br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters.Builder(this);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters other = (br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters) obj;
    ...
    public static final Creator<br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters> CREATOR =
            new Creator<br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters>() {

                @Override
                public br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters createFromParcel(Parcel in) {
                    return new br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters(in);
                }

                @Override
                public br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters[] newArray(int size) {
                    return new br.com.vr.pes360.dashSRD.track_selection.CustomTrackSelectionParameters[size];
                }
            };
}
