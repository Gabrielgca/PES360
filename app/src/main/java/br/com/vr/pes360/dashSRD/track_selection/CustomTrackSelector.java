...
import br.com.vr.pes360.dashSRD.track_selection.TiledVideoMappingTrackSelector;
 ...
 * the methods of this class from the application thread. See {@link Parameters()} for
...
public class CustomTrackSelector extends TiledVideoMappingTrackSelector {
   ...
   */
  public static final class ParametersBuilder extends CustomTrackSelectionParameters.Builder {
  ...
  /**
   * Extends {@link CustomTrackSelectionParameters} by adding fields that are specific to {@link
   * CustomTrackSelector}.
   */
  public static final class Parameters extends CustomTrackSelectionParameters {
  ...
  /** @deprecated Use {@link #CustomTrackSelector(Context)} instead. */
  @Deprecated
  public CustomTrackSelector() {
    this(Parameters.DEFAULT_WITHOUT_CONTEXT, new AdaptiveTrackSelection.Factory());
  }

  /** @deprecated Use {@link #CustomTrackSelector(Context, ExoTrackSelection.Factory)}. */
  @Deprecated
  public CustomTrackSelector(ExoTrackSelection.Factory trackSelectionFactory) {
   ...
   */
  public CustomTrackSelector(Context context, ExoTrackSelection.Factory trackSelectionFactory) {
