...
public final class DashSRDMediaSource implements MediaSource {
     ...
     * duration by which t he default start position precedes the end of the live window.
     */
    ...
    private final EventDispatcher.ListenerAndHandler listenerAndHandler;
    ...
    private DashSRDMediaSource(DashManifest manifest, Uri manifestUri,
        ...
        //Verificar listenerAndHandlers se der errado
        eventDispatcher = new EventDispatcher();
        eventDispatcher.addEventListener(eventHandler,eventListener);
    ...
    private void scheduleManifestRefresh() {
        ...
        long minUpdatePeriod = manifest.minUpdatePeriodMs;
