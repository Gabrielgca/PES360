...
/**
 * A DASH {@link MediaSource} supporting tiled videos. This class has very few
 * changes on the original DashMediaSource.
 */
public final class DashSRDMediaSource extends BaseMediaSource {

    static {
        ExoPlayerLibraryInfo.registerModule("goog.exo.dash");
    }

    /** Factory for {@link DashSRDMediaSource}s. */
    public static final class Factory implements MediaSourceFactory {
        ...
        /**
         * Creates a new factory for {@link DashSRDMediaSource}s.
         *
        ...
        public Factory(DataSource.Factory dataSourceFactory) {
            //TODO : VERIFICAR DEFAULTDASHCHUNKSOURCE
            this(new DefaultDashSRDChunkSource.Factory(dataSourceFactory), dataSourceFactory);
        }
        ...
        /**
         * Returns a new {@link DashSRDMediaSource} using the current parameters and the specified
         * sideloaded manifest.
         *
         * @param manifest The manifest. {@link DashManifest#dynamic} must be false.
         * @return The new {@link DashSRDMediaSource}.
         * @throws IllegalArgumentException If {@link DashManifest#dynamic} is true.
         */
        public DashSRDMediaSource createMediaSource(DashManifest manifest) {
         ...
         * @throws IllegalArgumentException If {@link DashManifest#dynamic} is true.
         */
        public DashSRDMediaSource createMediaSource(DashManifest manifest, MediaItem mediaItem) {
        ...
        @Deprecated
        @Override
        public DashSRDMediaSource createMediaSource(Uri uri) {
            return createMediaSource(
                    new MediaItem.Builder()
                            .setUri(uri)
                            .setMimeType(MimeTypes.APPLICATION_MPD)
        ...
        /**
         * Returns a new {@link DashSRDMediaSource} using the current parameters.
         *
         ...
         */
        @Override
        public DashSRDMediaSource createMediaSource(MediaItem mediaItem) {
            checkNotNull(mediaItem.playbackProperties);
            @Nullable ParsingLoadable.Parser<? extends DashManifest> manifestParser = this.manifestParser;
            if (manifestParser == null) {
                manifestParser = new DashSRDManifestParser();
            }
            List<StreamKey> streamKeys =
    ...
    public static final String DEFAULT_MEDIA_ID = "DashSRDmediaSource";
    ...
    private static final String TAG = "DashSRDMediaSource";
    ...
    protected void prepareSourceInternal(@Nullable TransferListener mediaTransferListener) {
        ...
        if (sideloadedManifest) {
            ...
            loader = new Loader("DashSRDmediaSource");
    ...
    public MediaPeriod createPeriod(
        ...
        DashSRDMediaPeriod mediaPeriod =
                new DashSRDMediaPeriod(
                        ...
                        allocator,
                        compositeSequenceableLoaderFactory,
                        playerEmsgCallback, dynamicEditingHolder, tileQualityTracker, replacementTracker);
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        DashSRDMediaPeriod dashMediaPeriod = (DashSRDMediaPeriod) mediaPeriod;
    ...
    private final class DefaultPlayerEmsgCallback implements PlayerEmsgCallback {
        ...
        public void onDashManifestRefreshRequested() {
            DashSRDMediaSource.this.onDashManifestRefreshRequested();
        }

        @Override
        public void onDashManifestPublishTimeExpired(long expiredManifestPublishTimeUs) {
            DashSRDMediaSource.this.onDashManifestPublishTimeExpired(expiredManifestPublishTimeUs);
        }
    }
    ...
    private final class ManifestCallback implements Loader.Callback<ParsingLoadable<DashManifest>> {
        ...
        public void onLoadCanceled(
                ...
                long loadDurationMs,
                boolean released) {
            DashSRDMediaSource.this.onLoadCanceled(loadable, elapsedRealtimeMs, loadDurationMs);
        }
