...
public class OurCustomRenderersFactory implements RenderersFactory {
    /**
    ...
    private static final String TAG = "OurCustomRenderersFactory";

    private final Context context;
    @OurCustomRenderersFactory.ExtensionRendererMode
    ...
    public OurCustomRenderersFactory(Context context, int videoRendererCount) {
     ...
     */
    public OurCustomRenderersFactory setExtensionRendererMode(
            @OurCustomRenderersFactory.ExtensionRendererMode int extensionRendererMode) {
     ...
     * @return This factory, for convenience.
     */
    public OurCustomRenderersFactory experimentalSetAsynchronousBufferQueueingEnabled(boolean enabled) {
     ...
     * @return This factory, for convenience.
     */
    public OurCustomRenderersFactory experimentalSetForceAsyncQueueingSynchronizationWorkaround(
            boolean enabled) {
     ...
     * @return This factory, for convenience.
     */
    public OurCustomRenderersFactory experimentalSetSynchronizeCodecInteractionsWithQueueingEnabled(
            boolean enabled) {
     ...
     * @return This factory, for convenience.
     */
    public OurCustomRenderersFactory setEnableDecoderFallback(boolean enableDecoderFallback) {
     ...
     * @return This factory, for convenience.
     */
    public OurCustomRenderersFactory setMediaCodecSelector(MediaCodecSelector mediaCodecSelector) {
     ...
     * @return This factory, for convenience.
     */
    public OurCustomRenderersFactory setEnableAudioFloatOutput(boolean enableFloatOutput) {
     ...
     * @return This factory, for convenience.
     */
    public OurCustomRenderersFactory setEnableAudioOffload(boolean enableOffload) {
     ...
     * @return This factory, for convenience.
     */
    public OurCustomRenderersFactory setEnableAudioTrackPlaybackParams(
     ...
     * @return This factory, for convenience.
     */
    public OurCustomRenderersFactory setAllowedVideoJoiningTimeMs(long allowedVideoJoiningTimeMs) {
    ...
    protected void buildCameraMotionRenderers(
            Context context, @OurCustomRenderersFactory.ExtensionRendererMode int extensionRendererMode, ArrayList<Renderer> out) {
    ...
    protected void buildMiscellaneousRenderers(Context context, Handler eventHandler,
                                               @OurCustomRenderersFactory.ExtensionRendererMode int extensionRendererMode, ArrayList<Renderer> out) {
        // Do nothing.
    }
